...
# ---------- 路径 ----------
PKL_IN  = '/data_volume_1/sjk_data/NuscenesGrounding/talk2car_dataset/train_commands_3d_lidarCentre_lidar2CamIns.pkl'
PKL_OUT = '/data_volume_1/sjk_data/NuscenesGrounding/talk2car_dataset/train_commands_3d_lidarCentre_lidar2CamIns2.pkl'
...
for smp in tqdm.tqdm(samples, desc='Project & IoU'):
    ...
    # 投影
    cam_ins   = smp['lidar2CamIns']['CAM_FRONT']
...
# ---------- 路径 ----------
PKL_IN  = '/data_volume_1/sjk_data/NuscenesGrounding/talk2car_dataset/test_commands_3d_lidarCentre_lidar2CamIns.pkl'
PKL_OUT = '/data_volume_1/sjk_data/NuscenesGrounding/talk2car_dataset/test_commands_3d_lidarCentre_lidar2CamIns2.pkl'
