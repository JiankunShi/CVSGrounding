...
# 4) 读取原 pkl、写入新字段并保存
# ------------------------------------------------------------------
train_pkl_path = '/data_volume_1/sjk_data/NuscenesGrounding/mmdet_all_train_data_map_caption_IOU03_yaw_egoCentre_multiView30_pro0P5_concatDesc.pkl'
train_pkl_output_path = '/data_volume_1/sjk_data/NuscenesGrounding/mmdet_all_train_data_map_caption_IOU03_yaw_egoCentre_multiView30_pro0P5_concatDesc_lidar2CamIns.pkl'
...
for sample in tqdm.tqdm(all_train_samples, desc='Caching lidar→cam params'):
    ...
    if 'lidar2CamIns' not in sample:
        sample['lidar2CamIns'] = get_lidar2CamIns(sample['sample_token'])
...
val_pkl_path = '/data_volume_1/sjk_data/NuscenesGrounding/mmdet_all_val_data_map_caption_IOU03_yaw_egoCentre_multiView30_pro0P5_concatDesc.pkl'
val_pkl_output_path = '/data_volume_1/sjk_data/NuscenesGrounding/mmdet_all_val_data_map_caption_IOU03_yaw_egoCentre_multiView30_pro0P5_concatDesc_lidar2CamIns.pkl'
