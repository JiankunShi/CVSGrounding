...
db_sampler = dict(
    ...
    data_root='/data_volume_3/nuscenes/v1_0/',
    info_path='/data_volume_3/nuscenes/v1_0/nuscenes_dbinfos_train.pkl',
    points_loader=dict(
        backend_args=None,
        coord_type='LIDAR',
        load_dim=5,
...
launcher = 'none'
load_from = '/data_volume_1/sjk_pretrain_model/bevfusionModel/bevfusion_lidar_voxel0075_second_secfpn_8xb4-cyclic-20e_nus-3d-2628f933.pth'
log_level = 'INFO'
...
optim_wrapper = dict(
    ...
    optimizer=dict(lr=2e-05, type='AdamW', weight_decay=0.01),
    type='OptimWrapper')
param_scheduler = [
    dict(
        begin=0,
...
test_evaluator = dict(
    ann_file='/data_volume_3/nuscenes/v1_0/nuscenes_infos_val.pkl',
    backend_args=None,
    data_root='/data_volume_3/nuscenes/v1_0/',
    metric='bbox',
    type='NuScenesMetric')
