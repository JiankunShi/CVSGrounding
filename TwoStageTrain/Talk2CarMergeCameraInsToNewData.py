...
# 定义文件路径
mini_train_file = '/data_volume_1/sjk_data/NuscenesGrounding/talk2car_dataset/talk2car_train_one_stage_output.pkl'
other_train_file = '/data_volume_1/sjk_data/NuscenesGrounding/talk2car_dataset/train_commands_3d_lidarCentre_lidar2CamIns2_addCategoryName.pkl'
output_file = '/data_volume_1/sjk_data/NuscenesGrounding/talk2car_dataset/merge_train_one_stage_output.pkl'
...
for item in other_train_data:
    ...
    lidar2CamIns = item['lidar2CamIns']['CAM_FRONT']
