...
def save_checkpoint(epoch: int, test_loss: float):
    ...
    torch.save({
        ...
        "text_proj2_state_dict": text_proj2.state_dict(),
...
st_time = time.time()
# 加载数据
train_file_path = '/data_volume_1/sjk_data/NuscenesGrounding/merge_train_one_stage_output.pkl'
# test_file_path = '/data_volume_1/sjk_data/NuscenesGrounding/merge_val_one_stage_output.pkl'
test_file_path = '/data_volume_1/sjk_data/NuscenesGrounding/merge_val_one_stage_output.pkl'
...
params += list(text_proj2.parameters())
...
#这是以前版本的加载
# checkpoint = torch.load('/home/jiankunshi/python/Bevfusion_FineTuneByPre_GroundingDINO/TwoStageTrain/save_model/epoch20_5851_5620_SPNuscenes.pth')
...
#下面是加了cross_attn后版本的加载数据
# checkpoint = torch.load('/home/jiankunshi/python/Bevfusion_FineTuneByPre_GroundingDINO/TwoStageTrain/save_model/epoch20_5851_5620_SPNuscenes.pth')
# checkpoint = torch.load(checkpoint)
# text_proj.load_state_dict(checkpoint["model_state_dict"])
# text_proj2.load_state_dict(checkpoint["text_proj2_state_dict"])
# cross_attn.load_state_dict(checkpoint["cross_attention_state_dict"])
